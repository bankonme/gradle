...
class BlockingHttpServerTest extends ConcurrentSpec {
    ...
    def "fails when some but not all expected parallel requests received"() {
        ...
        e.message == 'Failed to handle all HTTP requests.'
        e.causes.message.sort() == [
            'Timeout waiting to handle GET /a. Waiting for [GET /b], already received [GET /a]'
        ]
    }
    ...
    def "fails when expected parallel request received after other request has failed"() {
        ...
        e.causes.message == [
            'Timeout waiting to handle GET /a. Waiting for [GET /b], already received [GET /a]',
            'Timeout waiting to handle GET /b. Waiting for [], already received [GET /a, GET /b]'
        ]
    }
    ...
    def "fails when request method does not match expected parallel request"() {
        ...
        e.causes.message == [
            ...
            'Failed to handle GET /b due to unexpected request HEAD /a received. Waiting for [GET /a, PUT /c], already received [GET /b]',
    ...
    def "fails when request method does not match expected blocking parallel request"() {
        ...
        e.causes.message == [
            ...
            'Failed to handle GET /b due to unexpected request HEAD /a received. Waiting for 2 further requests, received [GET /b], released [], not yet received [GET /a, PUT /c]',
    ...
    def "fails when some but not all expected parallel requests received while waiting"() {
        ...
        e.message == 'Failed to handle all HTTP requests.'
        e.causes.message == [
            'Timeout waiting to handle GET /a. Waiting for 1 further requests, received [GET /a], released [], not yet received [GET /b, GET /c]'
        ]
    }
    ...
    def "fails when expected parallel request received after waiting has failed"() {
        ...
        def e = thrown(RuntimeException)
        e.message == 'Failed to handle all HTTP requests.'
        // TODO - message should indicate that /b happened after the timeout
        e.causes.message == [
            'Timeout waiting to handle GET /a. Waiting for 1 further requests, received [GET /a], released [], not yet received [GET /b, GET /c]',
            'Timeout waiting to handle GET /b. Waiting for 0 further requests, received [GET /a, GET /b], released [], not yet received [GET /c]'
        ]
    }
    ...
    def "fails when unexpected request received while other request is waiting "() {
        ...
        e.message == 'Failed to handle all HTTP requests.'
        e.causes.message == [
            'Failed to handle GET /a due to unexpected request GET /c received. Waiting for [GET /b], already received [GET /a]',
    ...
    def "fails when unexpected request received while waiting"() {
        ...
        e.message == 'Failed to handle all HTTP requests.'
        e.causes.message == [
            'Failed to handle GET /a due to unexpected request GET /d received. Waiting for 1 further requests, received [GET /a], released [], not yet received [GET /b, GET /c]',
    ...
    def "fails when too many concurrent requests received while waiting"() {
        ...
        e.causes.message.sort() == [
            'Failed to handle GET /a due to unexpected request GET /c received. Waiting for 0 further requests, received [GET /a, GET /b], released [], not yet received [GET /c]',
            'Failed to handle GET /b due to unexpected request GET /c received. Waiting for 0 further requests, received [GET /a, GET /b], released [], not yet received [GET /c]',
    ...
    def "fails when request is not released when stop called"() {
        ...
        e.message == 'Failed to handle all HTTP requests.'
        e.causes.message == [
            'Timeout waiting to handle GET /a. Waiting for 0 further requests, received [GET /a, GET /b], released [], not yet received [GET /c]',
            'Timeout waiting to handle GET /b. Waiting for 0 further requests, received [GET /a, GET /b], released [], not yet received [GET /c]'
        ]
    }
